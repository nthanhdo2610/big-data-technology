 ...
 *
 * @Problem 2: Write a MapReduce java program with combiner (no in-mapper combining) to calculate the average temperature per year.
 */
...
public class AverageTemperature_Combiner extends Configured implements Tool
{
	...
	public static class CombinerAvgTempCombiner extends Reducer<Text, AvgTempInYear, Text, AvgTempInYear>
	{
	...
	public static void main(String[] args) throws Exception
	{
		...
		int res = ToolRunner.run(conf, new AverageTemperature_Combiner(), args);
	...
	{
		Job job = new Job(getConf(), "AverageTemperature_Combiner");
		job.setJarByClass(AverageTemperature_Combiner.class);
