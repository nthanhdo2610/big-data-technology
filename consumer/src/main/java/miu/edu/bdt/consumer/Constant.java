...
public class Constant {
    ...
    public static final String CREATE_WEATHER_TABLE_SQL = "CREATE TABLE IF NOT EXISTS %s (zip_code STRING,temperature FLOAT,updated_date TIMESTAMP) STORED AS PARQUET";
